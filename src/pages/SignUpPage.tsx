import FormRegistry from "../components/auth/FormRegistry";
            ...
            <div className="login-layout w-full" style={{ backgroundColor: '#e8f3ff', height: '100vh' }}>
                <div className="header-layout justify-center flex">
                    <div className='mt-10 mb-5 text-center w-1/3'>
                        ...
                        <p className='mt-3 text-sm' style={{ color: 'rgb(51, 51, 51)' }}>Đăng kí ứng dụng để sử dụng các dịch vụ của chúng tui <br /> Rất vui gặp bạn lúc này</p></div>
                </div>
