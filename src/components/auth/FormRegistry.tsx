...
export default function FormRegistry() {
    ...
    const [formRegistry, setFormRegistry] = useState<FormRegistryInterface>({
        username: '',
        password: '',
        rePassword: '',
    });
            ...
            <div className=" w-1/3 p-3 bg-white shadow-md rounded-md">
                ...
                <form className="rounded px-8 pt-6 pb-8 mb-4  border-t-2" onSubmit={(e) => submitForm(e)}>
                    <div className="mb-5">
                        ...
                        <input
                            onChange={(e) => setFormRegistry((form) => ({ ...form, username: e.target.value }))}
                            className={`shadow appearance-none border ${
                                error.username || response ? 'border-red-500' : ''
                    ...
                    <div className="mb-5">
                        ...
                        <input
                            onChange={(e) => setFormRegistry((form) => ({ ...form, password: e.target.value }))}
                            className={`shadow appearance-none border ${
                    ...
                    <div className="mb-8">
                        ...
                        <input
                            ...
                            className={`shadow appearance-none border ${
                                error.rePassword ? 'border-red-500' : ''
                            } rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline`}
                            id="rePassword"
                            type="password"
                            placeholder="********"
